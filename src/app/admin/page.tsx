        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1">Nina GSI — v1.0.2 - Mise à jour</p>
            </div>
          </div>
          <button
            onClick={() => {
...
function AIConfigEditor({ onBack }: { onBack: () => void }) {
   ...
   const handleSave = async () => {
      ...
      toast.success("Configuration de l'Assistant enregistrée !");
   };
   ...
   return (
      <div className="space-y-6">
         ...
         <div className="bg-white p-6 rounded-[32px] border border-gray-100 shadow-xl space-y-6">
            <div className="space-y-2">
               <label className="text-[10px] font-black uppercase text-gray-400 ml-2">Clé API Agent Assistant</label>
               <input
                  type="password"
                  value={config.apiKey}
            ...
            <div className="pt-4 border-t border-gray-100 space-y-4">
               ...
               <div className="space-y-2">
                  ...
                  <textarea
                     ...
                     placeholder="Dites à votre agent comment se comporter avec les étudiants..."
